...
import ua.kostenko.battleship.battleship.engine.GameImplTest;
...
import ua.kostenko.battleship.battleship.persistence.InMemoryPersistence;
...
class ControllerApiImplTest {
    ...
    void testGetGameEditions() {
        ...
        assertEquals(2, gameEditionsResponse.getBody().size());
    ...
    void testCreatePlayerInSession() {
        ...
        assertFalse(createPlayerResponse.getBody().isActive());
        assertFalse(createPlayerResponse.getBody().isReady());
        assertFalse(createPlayerResponse.getBody().isWinner());
        assertEquals("player_1", createPlayerResponse.getBody().getPlayerName());

        var game = persistence.load(emptySessionId);
        assertTrue(game.isPresent());
        assertNotNull(game.get().getPlayer(createPlayerResponse.getBody().getPlayerId()));

        controller.createPlayerInSession(emptySessionId, "player_2");

        assertThrows(InternalGameException.class,
    ...
    void testGetPlayer() {
        var getPlayerResponse =
                controller.getPlayer(sessionIdWithPlayers, sessionIdWithPlayersPlayer1ID);

        assertEquals(HttpStatus.OK, getPlayerResponse.getStatusCode());
        assertNotNull(getPlayerResponse.getBody());
        assertEquals(sessionIdWithPlayersPlayer1ID, getPlayerResponse.getBody().getPlayerId());

        assertThrows(InternalGameException.class,
                     () -> controller.getPlayer(emptySessionId, "player_3"));
    }
    ...
    void testStartGame() {
        ...
        GameImplTest.addShipsToField(game.get().getPlayer(sessionIdWithPlayersPlayer1ID));

        assertThrows(InternalGameException.class,
                     () -> controller.startGame(emptySessionId, "player"));
        ...
        assertEquals(sessionIdWithPlayersPlayer1ID, startGameResponse.getBody().getPlayerId());
        assertTrue(startGameResponse.getBody().isReady());
    }
    ...
    void testGetOpponent() {
        ...
        assertThrows(InternalGameException.class,
                     () -> controller.startGame(emptySessionId, "player_1"));

        var getOpponentResponse =
                controller.getOpponent(sessionIdWithPlayers, sessionIdWithPlayersPlayer1ID);

        assertEquals(HttpStatus.OK, getOpponentResponse.getStatusCode());
        assertNotNull(getOpponentResponse.getBody());
        assertEquals(playerName2, getOpponentResponse.getBody().getPlayerName());
        assertFalse(getOpponentResponse.getBody().isReady());
        assertFalse(getOpponentResponse.getBody().isWinner());
        assertFalse(getOpponentResponse.getBody().isActive());
    }
    ...
    void testGetField() {
        ...
        var getFieldResponse =
                controller.getField(sessionIdWithPlayers, sessionIdWithPlayersPlayer1ID);
        ...
        assertTrue(cells.stream().anyMatch(c -> Objects.nonNull(c.getShip())));
    ...
    void testGetFieldOfOpponent() {
        ...
        assertFalse(cells.stream().anyMatch(c -> Objects.nonNull(c.getShip())));
    ...
    void testGetPrepareShipsList() {
        ...
        assertEquals(10, getPrepareShipsListResponse.getBody().size());

        assertThrows(InternalGameException.class,
                     () -> controller.getField(emptySessionId, "non_existing"));
    }
    ...
    void testAddShipToField() {
        ...
        var shipId =
                getPrepareShipsListResponse.getBody().stream().findAny().map(ShipDto::getShipId);
    ...
    void testRemoveShipFromField() {
        assertThrows(InternalGameException.class,
                     () -> controller.removeShipFromField(emptySessionId, "non_existing",
                                                          Coordinate.of(0, 0)));
    ...
    void testGetActivePlayer() {
        assertThrows(IllegalGameStateException.class,
                     () -> controller.getActivePlayer(emptySessionId));
        ...
        GameImplTest.addShipsToField(game.get().getPlayer(sessionIdWithPlayersPlayer1ID));
        GameImplTest.addShipsToField(game.get().getPlayer(sessionIdWithPlayersPlayer2ID));
        controller.startGame(sessionIdWithPlayers, sessionIdWithPlayersPlayer1ID);
        ...
        assertEquals(playerName1, getActivePlayerResponse.getBody().getPlayerName());
    }
    ...
    void testMakeShot() {
        ...
        var makeShotResponse = controller.makeShot(sessionIdWithPlayers,
                                                   sessionIdWithPlayersPlayer1ID,
                                                   Coordinate.of(0, 0));
        ...
        assertTrue(
                Set.of(ShotResult.HIT, ShotResult.DESTROYED).contains(makeShotResponse.getBody()));
    }
    ...
    void testGetNumberOfUndamagedCells() {
        ...
        var getNumberOfUndamagedCellsResponse =
                controller.getNumberOfUndamagedCells(sessionIdWithPlayers,
                                                     sessionIdWithPlayersPlayer2ID);
        ...
        var player2ShipCoordinates = FieldUtil.convertToFlatSet(game.get()
                                                                    .getPlayer(
                                                                            sessionIdWithPlayersPlayer2ID)
                                                                    .getField()
                                                                    .getField())
        ...
        controller.makeShot(sessionIdWithPlayers, sessionIdWithPlayersPlayer1ID,
                            player2ShipCoordinates.get());
    ...
    void testGetNumberOfNotDestroyedShips() {
        ...
        var getNumberOfNotDestroyedShipsResponse =
                controller.getNumberOfNotDestroyedShips(sessionIdWithPlayers,
                                                        sessionIdWithPlayersPlayer2ID);
    ...
    void testGetWinner() {
        ...
        var coordinatesOfOpponentShips = FieldUtil.convertToFlatSet(game.get()
                                                                        .getPlayer(
                                                                                sessionIdWithPlayersPlayer2ID)
                                                                        .getField()
                                                                        .getField())
        ...
        assertTrue(getWinnerResponse.getBody().isWinner());
        assertTrue(getWinnerResponse.getBody().isActive());
        assertTrue(getWinnerResponse.getBody().isReady());
        assertEquals(playerName1, getWinnerResponse.getBody().getPlayerName());
    }
}
