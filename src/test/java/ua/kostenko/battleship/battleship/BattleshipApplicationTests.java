...
class BattleshipApplicationTests {
    ...
    void get_editions_should_return_two_editions() {
        ...
        var response = restTemplate.exchange(url_get_editions, HttpMethod.GET, HttpEntity.EMPTY, GameEditionsDto.class);
    ...
    void post_sessions_should_return_SessionID() {
        ...
        var response =
                this.restTemplate.exchange(url_post_sessions, HttpMethod.POST, requestBody, GameSessionIdDto.class);
    ...
    void put_ships_should_add_ship_to_player_field() {
        ...
        var url_put_add_ships = "%s/api/game/sessions/{sessionId}/players/{playerId}/ships/{shipId}".formatted(baseUrl);
    ...
    void delete_ship_should_remove_ship_from_field() {
        ...
        var url_delete_ship = "%s/api/game/sessions/{sessionId}/players/{playerId}/ships?delete".formatted(baseUrl);
    ...
    void post_players_start_should_change_player_state() {
        ...
        var url_post_players_start = "%s/api/game/sessions/{sessionId}/players/{playerId}?start".formatted(baseUrl);
    ...
    void get_players_player_id_field_should_return_field() {
        ...
        var url_get_players_field = "%s/api/game/sessions/{sessionId}/players/{playerId}/field".formatted(baseUrl);
    ...
    void get_players_cells_should_return_number_of_cells_not_damaged() {
        ...
        var url_get_players_cells = "%s/api/game/sessions/{sessionId}/players/{playerId}/cells".formatted(baseUrl);
    ...
    private void makeShotsToWinPlayer2(
            final GameSessionIdDto session, final PlayerDto player_1, final PlayerDto player_2) {
        var url_get_players_field = "%s/api/game/sessions/{sessionId}/players/{playerId}/field".formatted(baseUrl);
