...
`master`. The backend layering and the game engine's state machine
...
the two sequence diagrams match the current Vite/React 19 frontend, including SSE stale-fallback polling
