...
describe('DirectionToggle', () => {
  it('renders both direction buttons with the supplied labels', () => {
    render(<DirectionToggle direction="HORIZONTAL" onChange={() => {}} horizontalLabel="Horizontal" verticalLabel="Vertical" />);
  ...
  it('marks the Vertical button active (class + aria-pressed) when direction is VERTICAL', () => {
    render(<DirectionToggle direction="VERTICAL" onChange={() => {}} horizontalLabel="Horizontal" verticalLabel="Vertical" />);
  ...
  it('calls onChange with HORIZONTAL when the Horizontal button is clicked', async () => {
    ...
    render(<DirectionToggle direction="VERTICAL" onChange={onChange} horizontalLabel="Horizontal" verticalLabel="Vertical" />);
  ...
  it('calls onChange with VERTICAL when the Vertical button is clicked', async () => {
    const user = userEvent.setup();
    const onChange = vi.fn();
    render(<DirectionToggle direction="HORIZONTAL" onChange={onChange} horizontalLabel="Horizontal" verticalLabel="Vertical" />);
