...
- T007, T008, and T009 run in parallel after T006. T010 runs in parallel with
  T007-T009 after T005 because it owns only `QrCodeSheet.css`; T006 exclusively
  owns `WaitScreen.css`. T011 depends on
